    ...
    //      	 goto_next_panel();
        ...
        function add_panel(panel_id){
          	...
          	if (panel_id == 0){
                ...
                var size = categories[status.cat.key].subcategories[status.subcat.key].size;
  ...
  //        	 goto_form_element(status.current_step);
        ...
        function add_form_element(element_id){
          	...
          	if (element_id == 0){
                ...
                var subcategory = categories[status.cat.key].subcategories[status.subcat.key].name;
                ...
                for(var i = 0; i < size.length; i++){
                	var str=size[i].name;
                	if(changedName == "Size"){
	                	if(subcategory == 'Independent or Nonprofit Education Institutes/Centers')
	                		changedName = "Annual Budget";
	                	else{
		                	if(str.indexOf("$") !== -1)
		                		   changedName = "Revenue";
		                	else
       ...
       //           	 goto_form_element(status.current_step);
                ...
                status.dues = categories[status.cat.key].subcategories[status.subcat.key].size[status.size.key].dues;
