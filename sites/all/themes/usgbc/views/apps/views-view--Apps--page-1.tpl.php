...
$title = ($_GET['title'] != '') ? $_GET['title'] : 'Search apps';
  ...
  <div id="events-search" class="jumbo-search">
                        <div class="jumbo-search-container">
                            <form action="<?php echo $currenturl[0];?>" method="get">
                              <input type="text" class="jumbo-search-field default" name="title" value="<?php echo $title ; ?>" >
...
<?php echo (intval($view->total_rows) == 1) ? ' result in' : ' results in'?>
<strong>
<?php 
