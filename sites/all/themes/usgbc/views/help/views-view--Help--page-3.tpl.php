    ...
    <div id="navCol">				
				<div class="mini-search">
				    <div class="mini-search-container">
	            	    <form method="get" action="/help/search-results">
				        <input class="mini-search-field" type="text" name="name" value="Search help" />
				        <input class="mini-search-button" type="submit" name="" value="Search" src="/themes/usgbc/lib/img/search-icon-button.gif" />
				    	</form>
				    </div>
				</div>
