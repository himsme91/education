...
//The view for Staff-picked course workshops on courses landing page
...
?>
		...
		<div class="grid_3 lp-course block-link">
			<img alt="" src="<?php echo $feature_img_src ;?>">
			<h4 class="title"><?php echo $title; ?></h4>
			<div class="left five-star"><?php echo $fivestar_widget; ?></div>
			<?php if( $ce_hours > 0){
				echo '<div class="meta-item right CE">';
		...
		<div class="hide">
			<div class="id">
				<span class="meta-item id">ID <strong> <?php echo $fields['field_crs_id_value']->content; ?></strong></span>
			</div>
			...
			<div class="level">
				<span class="meta-item right level">Level <strong> <?php echo $fields['field_crs_level_value']->content; ?></strong></span>
			</div>
			<div class=summary>
			<?php
		...
		?><p><?php echo $text."...";?>
		<a  href="<?php echo $course_path; ?>">more info</a></p>
		<?php } ?>
			</div>
