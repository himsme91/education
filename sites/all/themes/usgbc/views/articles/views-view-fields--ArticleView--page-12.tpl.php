...
<div class="bg-list">
	<div class="bg-entry">
		...
		<div class="bg-entry-header">
			...
			<span class="bg-entry-header-section">Posted in <strong><a href="/articles/<?php print usgbc_dashencode($fields['name']->content);?>"><?php print $fields['name']->content;?></a></strong></span>
		</div>
