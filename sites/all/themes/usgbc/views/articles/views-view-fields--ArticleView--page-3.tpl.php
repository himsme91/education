...
<div class="bg-list">
	<div class="bg-entry">
		...
		<div class="bg-entry-header">
			<span class="bg-entry-header-section">Published on <strong><?php print $fields['created']->content;?></strong></span>
			<span class="bg-entry-header-section">Written by <strong><?php print $fields['name_1']->content;?></strong></span>
			<span class="bg-entry-header-section">Posted in <strong><a href="/articles/<?php print usgbc_dashencode(strtolower($fields['name']->content));?>"><?php print $fields['name']->content;?></a></strong></span>
		</div>
