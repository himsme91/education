...
$lvl_sort = ($_GET['lvl_sort'] == 'unsorted' || $_GET['lvl_sort'] == '') ? $_GET['lvl_sort'] : 'ASC';
 ...
 <div class="ag-header">
   ...
   <div class="ag-sort">
    ...
    <div id="items-sort-selector" class="ag-sort-container">
    	<select>
			<option value="title_sort=ASC&lvl_sort=unsorted&list_price_sort=unsorted"<?php echo ($title_sort == 'ASC') ? ' selected="selected"' : ''; ?>>A-Z</option>
			<option value="title_sort=unsorted&lvl_sort=ASC&list_price_sort=unsorted"<?php echo ($lvl_sort == 'ASC') ? ' selected="selected"' : ''; ?>>Level</option>
			<option value="title_sort=unsorted&lvl_sort=unsorted&list_price_sort=ASC"<?php echo ($price_sort == 'ASC') ? ' selected="selected"' : ''; ?>>Price</option>
		</select>
	</div>
</div> 
