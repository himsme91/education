...
<div class="<?php print strtolower(rtrim($fields['field_res_type_value']->content,"s"));?> resource-thumb"></div>
 ...
 <div class="contribute-options button-group">
	<p class="sub-text left">Saved <?php print $fields['changed']->content;?></p>
     <a class="small-alt-button right" href="/node/<?php print $fields['nid']->content;?>/edit">Edit</a>
     <a class="small-button right delete-article" href="/node/<?php print $fields['nid']->content;?>/delete">Delete</a> 
</div>							
